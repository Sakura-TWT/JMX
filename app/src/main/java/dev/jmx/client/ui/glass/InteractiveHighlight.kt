            ...
            if (progress > 0f) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && shader != null) {
                    ...
                    shader.apply {
                        ...
                        setColorUniform("color", Color.White.copy(0.16f * progress).toArgb())
                        setFloatUniform("radius", size.minDimension * 1.45f)
                        setFloatUniform(
                            "position",
                    ...
                    drawRect(Color.White.copy(0.22f * progress), blendMode = BlendMode.Plus)
                }
            }
            drawContent()
        }
